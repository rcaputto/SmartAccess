...
INSERT INTO "new_AccessCode" ("bookingId", "code", "createdAt", "endsAt", "errorMessage", "externalId", "id", "lastSyncedAt", "provider", "startsAt", "status", "updatedAt") SELECT "bookingId", "code", "createdAt", "endsAt", "errorMessage", "externalId", "id", "lastSyncedAt", "provider", "startsAt", "status", "updatedAt" FROM "AccessCode";
...
INSERT INTO "new_AuditLog" ("action", "actorLabel", "actorType", "createdAt", "details", "entityId", "entityType", "id") SELECT "action", "actorLabel", "actorType", "createdAt", "details", "entityId", "entityType", "id" FROM "AuditLog";
DROP TABLE "AuditLog";
...
INSERT INTO "new_Booking" ("checkInDate", "checkOutDate", "createdAt", "guestCount", "guestId", "id", "notes", "reference", "status", "unitId", "updatedAt") SELECT "checkInDate", "checkOutDate", "createdAt", "guestCount", "guestId", "id", "notes", "reference", "status", "unitId", "updatedAt" FROM "Booking";
DROP TABLE "Booking";
...
INSERT INTO "new_Guest" ("createdAt", "documentId", "email", "fullName", "id", "phone", "updatedAt") SELECT "createdAt", "documentId", "email", "fullName", "id", "phone", "updatedAt" FROM "Guest";
DROP TABLE "Guest";
...
INSERT INTO "new_NotificationDelivery" ("accessCodeId", "attempt", "body", "bookingId", "channel", "createdAt", "errorMessage", "failedAt", "id", "providerMessageId", "reason", "recipient", "sentAt", "status", "updatedAt") SELECT "accessCodeId", "attempt", "body", "bookingId", "channel", "createdAt", "errorMessage", "failedAt", "id", "providerMessageId", "reason", "recipient", "sentAt", "status", "updatedAt" FROM "NotificationDelivery";
...
INSERT INTO "new_Property" ("address", "city", "country", "createdAt", "id", "name", "updatedAt", "userId") SELECT "address", "city", "country", "createdAt", "id", "name", "updatedAt", "userId" FROM "Property";
DROP TABLE "Property";
...
INSERT INTO "new_Unit" ("createdAt", "description", "id", "isActive", "maxGuests", "name", "propertyId", "updatedAt") SELECT "createdAt", "description", "id", "isActive", "maxGuests", "name", "propertyId", "updatedAt" FROM "Unit";
DROP TABLE "Unit";
